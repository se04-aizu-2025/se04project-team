...
object AlgorithmContentProvider {
    ...
    fun getConcept(sortType: SortType): AlgorithmConcept {
        return when (sortType) {
            ...
            else -> AlgorithmConcept(
                sortType = sortType,
                howItWorks = "Content not available.",
                keyIdea = "-",
                steps = emptyList()
            )
        }
    ...
    fun getUseCase(sortType: SortType): AlgorithmUseCase {
        return when (sortType) {
            ...
            else -> AlgorithmUseCase(
                sortType = sortType,
                bestUseCases = emptyList(),
                notRecommended = emptyList(),
                realWorldExamples = emptyList()
            )
        }
    }
    ...
    fun getImplementation(sortType: SortType): AlgorithmImplementation {
        return when (sortType) {
            ...
            else -> AlgorithmImplementation(
                sortType = sortType,
                code = "// Implementation not available",
                description = "-"
            )
        }
    }

---
name: rules
description: Read all development, design, and implementation rules for the DNSort project. Provides comprehensive information about coding conventions, architecture, Design System usage, and best practices.
---
